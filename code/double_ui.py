...
from code.double import encrypt, decrypt  # 确保这部分能找到正确的函数
...
class SAESApp(QWidget):
    ...
    def init_ui(self):
        self.setWindowTitle("双重 S-AES 加解密系统")
    ...
    def create_encrypt_ui(self):
        layout = QVBoxLayout()
        layout.addWidget(QLabel("双重 S-AES加密工具", font=QtGui.QFont("Arial", 16)))
    ...
    def create_decrypt_ui(self):
        layout = QVBoxLayout()
        layout.addWidget(QLabel("双重解密工具", font=QtGui.QFont("Arial", 16)))
